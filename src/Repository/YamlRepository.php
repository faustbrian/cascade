...
final readonly class YamlRepository implements ResolverRepositoryInterface
{
     ...
     * @throws YamlPackageRequiredException If symfony/yaml is not installed
     */
     ...
     *
     * @param  array<string>|string                $paths Single file path or array of file paths
     * @throws InvalidYamlFileException            If a file contains invalid YAML
     * @throws YamlFileMustContainArrayException   If a file does not contain an array
     * @throws YamlFileNotFoundException           If a file cannot be found
     * @throws YamlFileNotReadableException        If a file is not readable
     * @return array<string, array<string, mixed>> Map of resolver names to definitions
     */
