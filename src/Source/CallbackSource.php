...
final readonly class CallbackSource implements SourceInterface
{
     ...
     * @param null|callable(string, array<string, mixed>): bool $supports    Optional closure to check support
     * @param null|callable(mixed): mixed                       $transformer Optional closure to transform values
     */
