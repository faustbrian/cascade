...
final class SourceConductor
{
     ...
     *
     * @param SourceInterface|string|array<string, mixed> $source Source instance, name, or array
     ...
     *
     * @param SourceInterface|string|array<string, mixed> $source
     */
     ...
     * @param (callable(string, array<string, mixed>): string)|null $keyGenerator Custom key generator
     */
