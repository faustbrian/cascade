...
use Cline\Cascade\Exception\NoSourcesAvailableException;
...
describe('ResolutionFailedException', function (): void {
    describe('exception hierarchy', function (): void {
        test('extends CascadeException', function (): void {
            // Arrange & Act
            $exception = ResolutionFailedForKeyException::withAttemptedSources('test', ['source1']);
    ...
    describe('forKey()', function (): void {
        test('creates exception with single attempted source', function (): void {
            ...
            // Act
            $exception = ResolutionFailedForKeyException::withAttemptedSources($key, $sources);
    ...
    describe('noSourcesAvailable()', function (): void {
        test('creates exception with no sources available message', function (): void {
            ...
            // Act
            $exception = NoSourcesAvailableException::forKey($key);
        ...
        test('returns NoSourcesAvailableException instance', function (): void {
            // Arrange & Act
            $exception = NoSourcesAvailableException::forKey('test.key');

            // Assert
            expect($exception)->toBeInstanceOf(NoSourcesAvailableException::class);
        });
    });
    ...
    describe('exception message format', function (): void {
        test('forKey message contains key and sources', function (): void {
            // Arrange & Act
            $exception = ResolutionFailedForKeyException::withAttemptedSources('my.key', ['source1', 'source2']);
        ...
        test('noSourcesAvailable message contains key and no sources text', function (): void {
            // Arrange & Act
            $exception = NoSourcesAvailableException::forKey('my.key');
