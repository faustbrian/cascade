...
use Cline\Cascade\Exception\DuplicateSourceNameException;
use Cline\Cascade\Exception\InvalidSourceNameException;
use Cline\Cascade\Exception\InvalidSourcePriorityException;
use Cline\Cascade\Exception\InvalidSourceTypeException;
use Cline\Cascade\Exception\MissingSourceConfigurationException;
...
describe('InvalidSourceException', function (): void {
    describe('exception hierarchy', function (): void {
        test('extends SourceException', function (): void {
            // Arrange & Act
            $exception = MissingSourceConfigurationException::forKey('test');
    ...
    describe('missingConfiguration()', function (): void {
        test('creates exception with missing configuration message', function (): void {
            ...
            // Act
            $exception = MissingSourceConfigurationException::forKey($key);
    ...
    describe('invalidType()', function (): void {
        test('creates exception with invalid type and valid types list', function (): void {
            ...
            // Act
            $exception = InvalidSourceTypeException::forType($invalidType, $validTypes);
    ...
    describe('invalidName()', function (): void {
        test('creates exception with invalid name message', function (): void {
            ...
            // Act
            $exception = InvalidSourceNameException::forName($name);
    ...
    describe('duplicateName()', function (): void {
        test('creates exception with duplicate name message', function (): void {
            ...
            // Act
            $exception = DuplicateSourceNameException::forName($name);
    ...
    describe('invalidPriority()', function (): void {
        test('creates exception for string priority', function (): void {
            ...
            // Act
            $exception = InvalidSourcePriorityException::forValue($priority);
