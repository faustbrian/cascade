...
describe('Resolver', function (): void {
    ...
    describe('transformers', function (): void {
        test('applies transformer to resolved values', function (): void {
            ...
            $resolver->transform(fn ($value) => mb_strtoupper($value));
    ...
    describe('getOrFail', function (): void {
        ...
        test('exception includes attempted sources', function (): void {
            ...
            } catch (ResolutionFailedForKeyException $resolutionFailedForKeyException) {
                expect($resolutionFailedForKeyException->getMessage())->toContain('null-1');
                expect($resolutionFailedForKeyException->getMessage())->toContain('null-2');
            }
        });
    });
